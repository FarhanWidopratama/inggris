...
export default function GrammarPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6">
      <h1 className="text-2xl font-black tracking-tight">Grammar Wajib — 18 Rumus 1 Baris</h1>
      <p className="text-sm text-zinc-600">Gak perlu hafal teori tebal. Hafal rumus ini + EI em, langsung bisa kerja & TOEFL. Klik kartu → buka lesson.</p>
      ...
      <div className="mt-6 rounded-2xl bg-zinc-900 p-6 text-white">
        ...
        <div className="text-sm text-zinc-300">1. Hafal 18 rumus di atas 2. Buka lesson terkait 3. Quiz 5 soal per rumus 4. Salah → lihat ErrorReview di History.</div>
      </div>
    </div>
  );
}
